...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        Page.Children.onAfterEdit = function (tableid, index, row, changes) {
            if (tableid == "MMStockProductOutD") {
                var rows = $('#MMStockProductOutD').datagrid("getRows"); //我这里获取所有行，
                var qty = 0;
                for (var i = 0; i < rows.length; i++) {
                    qty = Number(qty) + Number(rows[i].fQty);
                }
                Page.setFieldValue("fQty", qty);
            }
        }
    </script>
</asp:Content>
            ...
            <div id="divContent" class="easyui-layout" data-options="fit:true">
                ...
                <div data-options="region:'center'">
                    ...
                    <div class="easyui-tabs" data-options="fit:true,border:false">
                        <div data-options="fit:true" title="出库单明细">
                            <!--  子表1  -->
