        ...
        <div data-options="region:'north'" style="overflow: hidden;">
            ...
            <table class="tabmain">
                ...
                <tr>
                    ...
                    <td>
                         <cc1:ExtTextBox2 ID="ExtTextBox13" runat="server" Z_FieldID="iQty" Z_disabled="true"
                             />
                    </td>
                    <%--<td>
                        盈亏金额
            ...
            <table class="tabmain">
                 <tr>
                    <%--<td>库位</td>
                    <td>
                        <cc1:ExtTextBox2 ID="ExtTextBox2" runat="server" Z_FieldID="ibscDataStockDRecNo"  Z_NoSave="true"  />
