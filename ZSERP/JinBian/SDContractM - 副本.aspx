                        ...
                        if (fuRows.length > 0) {
                            for (var i = 0; i < fuRows.length; i++) {
                                ...
                                var SqlObj1 = {
                                    ...
                                    Fields: "iBscDataMatRecNo,sCode,sName,iIsBottom,fProductWidth,fProductWeight",
                                    SelectAll: "True",
                                    Filters: [
                                        {
                                ...
                                if (result1.length > 0) {
                                    for (var j = 0; j < result1.length; j++) {
                                        ...
                                        var appRow = {
                                            ...
                                            fProductWidth: result1[j].fProductWidth,
                                            fProductWeight: result1[j].fProductWeight,
                            ...
                            if (r) {
                                ...
                                while (allRowsFu.length > 0) {
                                    ...
                                    if (deleteKey == "") {
                                        ...
                                        deleteKey = deleteKey + "," + allRowsFu[0].iRecNo;
                                    }
                ...
                <%--<div data-options="title:'订单信息',fit:true,border:false">--%>
                    ...
                    <table class="tabmain">
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td rowspan="6" id="showchange" style="vertical-align:top">
