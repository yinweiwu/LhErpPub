    ...
    <div id="divContent" class="easyui-layout" data-options="fit:true">
        ...
        <div data-options="region:'center'" style="overflow: hidden;">
            <div id="tt" class="easyui-tabs" data-options="fit:true,border:false">
                                ...
                                <a href="javascript:void(0)" style="font-size: 22px; font-weight: bold; text-decoration: none;
                                    color: Black;" onclick="setGYChar(this)">－</a>&nbsp;&nbsp; <a href="javascript:void(0)"
                                        ...
                                        onclick="setGYChar(this)">∨</a>&nbsp;&nbsp; <a href="javascript:void(0)" style="font-size: 22px;
                                            font-weight: bold; text-decoration: none; color: Black;" onclick="setGYChar(this)">∪</a>&nbsp;&nbsp; <a href="javascript:void(0)" style="font-size: 22px; font-weight: bold;
                ...
                <div data-options="fit:true" title="织造条件">
                    <table style="border-collapse: collapse; border: solid 1px #a0a0a0;" class="tabZDTJ">
                        <tr>
                            <th>
                            </th>
                            <th>
                        ...
                        <tr>
                            ...
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox31" runat="server" Z_FieldID="sSscl1" />
                            </td>
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox32" runat="server" Z_FieldID="sPsd1" />
                            </td>
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox33" runat="server" Z_FieldID="sPkd1" />
                            </td>
                            <td>
                                挡位
                            </td>
                            <td colspan="3">
                                <cc1:ExtTextBox2 ID="ExtTextBox47" runat="server" Z_FieldID="sDangwei" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox35" runat="server" Z_FieldID="sSscl2" />
                            </td>
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox36" runat="server" Z_FieldID="sPsd2" />
                            </td>
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox37" runat="server" Z_FieldID="sPkd2" />
                            </td>
                            <td>
                                撑布架
                            </td>
                            <td colspan="3">
                                <cc1:ExtTextBox2 ID="ExtTextBox46" runat="server" Z_FieldID="sCbj" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox39" runat="server" Z_FieldID="sSscl3" />
                            </td>
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox40" runat="server" Z_FieldID="sPsd3" />
                            </td>
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox41" runat="server" Z_FieldID="sPkd3" />
                            </td>
                            <td>
                                侧面齿轮
                            </td>
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox42" runat="server" Z_FieldID="sCmcl" />
                            </td>
                            <td>
                                筒高
                            </td>
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox38" runat="server" Z_FieldID="sTonggao" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox43" runat="server" Z_FieldID="sSscl4" />
                            </td>
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox44" runat="server" Z_FieldID="sPsd4" />
                            </td>
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox45" runat="server" Z_FieldID="sPkd4" />
                            </td>
                            <td>
                                食位
                            </td>
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox34" runat="server" Z_FieldID="sShiwei" />
                            </td>
                            <td>
                                涨力
                            </td>
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox50" runat="server" Z_FieldID="sZhangli" />
                            </td>
                        </tr>
                    </table>
                    <table>
                        <tr>
                            ...
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox48" runat="server" Z_FieldID="fFabWeightReal" Z_FieldType="数值"
                                    Z_decimalDigits="0" />
                            </td>
                            <td>
                                卷布门幅(实际)
                            ...
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox49" runat="server" Z_FieldID="fFabWidthReal" Z_FieldType="数值"
                                    Z_decimalDigits="0" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3">
                                <cc1:ExtTextArea2 ID="ExtTextArea1" Z_FieldID="sBeforeProblem1" runat="server" style="width:380px;" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td colspan="3">
                                <cc1:ExtTextArea2 ID="ExtTextArea2" Z_FieldID="sBeforeProblem2" runat="server" style="width:380px;" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td colspan="3">
                                <cc1:ExtTextArea2 ID="ExtTextArea4" Z_FieldID="sBeforeProblem3" runat="server" style="width:380px;" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td colspan="3">
                                <cc1:ExtTextArea2 ID="ExtTextArea5" Z_FieldID="sBeforeProblem4" runat="server" style="width:380px;" />
                            </td>
                        </tr>
                    </table>
                </div>
                <%--<div data-options="fit:true" title="之前问题">
                    <table id="table4" tablename="BscDataMatDProblemBefore">
                    </table>
                </div>--%>
            </div>
        </div>
