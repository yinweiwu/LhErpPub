                ...
                <div data-options="fit:true" title="织造条件">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <cc1:ExtTextArea2 ID="ExtTextArea1" runat="server" style="width:380px;" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td colspan="3">
                                <cc1:ExtTextArea2 ID="ExtTextArea2" runat="server" style="width:380px;" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td colspan="3">
                                <cc1:ExtTextArea2 ID="ExtTextArea4" runat="server" style="width:380px;" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td colspan="3">
                                <cc1:ExtTextArea2 ID="ExtTextArea5" runat="server" style="width:380px;" />
                            </td>
                        </tr>
                    </table>
                </div>
