...
$(function () {
    ...
    GetMainMenu(true, function (data) {
        ...
        var mainL_W = $(".main_logo").width() - $(".main_logo_r").width() - 60 - 267;
            ...
            if (findSecond == false) {
                GetSubMenu(data[li_index].iMenuID, true, function (data2) {
                    ...
                    for (var i = 0; i < data2.ds.length; i++) {
                        ...
                        var main_nav_item_dl = '<dl><dt><span><a class="' + _icon + '" href="javascript:;">' + data2.ds[i].sMenuName + '</a></span></dt><dd></dd></dl>';
                        me.find(".main_nav_item").append(main_nav_item_dl);
                        menuSecond.push(data2.ds[i]);
                    }
                    me.find(".main_nav_item dl").each(function () {
