        ...
        <div data-options="region:'north'">
            ...
            <table align="center">
                <tr>
                    ...
                    <td>
                        <cc1:ExtTextBox2 ID="ExtTextBox15" runat="server" Z_FieldID="sCustID" Z_readOnly="True" />
                    ...
                    <td rowspan="2">
                        <cc1:ExtTextArea2 ID="ExtTextArea1" runat="server" Z_FieldID="sChnAddr" Width="140px"
                            Height="40px" />
                    </td>
                </tr>
                <tr>
