...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(function () {
            if (Page.usetype == "add" || Page.usetype == "modify") {
                ...
                $("#SDOrderD").datagrid(
                {
                    ...
                    singleSelect: true,
                    columns: [[
                        { title: "样品订单号", field: "sOrderNo", width: 110, sortable: true },
                    ...
                    //                        { title: "客户", field: "sCustShortName", width: 80, sortable: true },
                        ...
                        { title: "订单数量", field: "fSumQty", width: 80, sortable: true },
                        { title: "已发货数量", field: "fOutQty", width: 80, sortable: true },
                        { title: "未发货数量", field: "fNoOutQty", width: 80, sortable: true },
                        { title: "销售单位", field: "sUnitSaleName", width: 60, sortable: true },
            ...
            if (Page.usetype == "modify" || Page.usetype == "view") {
                ...
                var sqlobj2 = { TableName: "vwMMStockProductOutM",
                    Fields: "sCustShortName,sOrderNo,sCode,sName,sColorID,sColorName,sPerson,sTel,sTransType,sPackageType,sAddress,iBscDataMatRecNo,iBscDataColorRecNo,iSdOrderMRecNo,iBscDataCustomerRecNo,fProductWeight,fProductWidth",
                    SelectAll: "True",
                    Filters: [
                    {
                        //字段名
        ...
        function btnOut(row, index) {
            ...
            Page.setFieldValue("iSDOrderDRecNo", row.iRecNo);
        ...
        function searchSDOrderD() {
            var sqlObjSDOrderD = {
                TableName: "vwSDOrderD_Sample",
                Fields: "*",
                SelectAll: "True",
                Filters: [
                  {
            ...
            var resultSDOrderD = SqlGetData(sqlObjSDOrderD);
            if (resultSDOrderD.length > 0) {
                $("#SDOrderD").datagrid("loadData", resultSDOrderD);
            }
        }
        ...
        <div title="销售出库单">
            <div id="divContent" class="easyui-layout" data-options="fit:true">
                <div style="display: none;">
                    ...
                    <cc1:ExtTextBox2 ID="ExtTextBox7" runat="server" Z_FieldID="iSDOrderDRecNo" Style="display: none;" />
