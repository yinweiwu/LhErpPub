    ...
    <script language="javascript" type="text/javascript">
        ...
        $(function () {            
            ...
            var sqlObjSup = {
                ...
                Filters: [
                    {
                        Field: "iCustType", ComOprt: "=", Value: "1", LinkOprt: "and"
                    }, {
                        Field: "iInner", ComOprt: "=", Value: "1"
                    }
                ]
            }
            var resultSup = SqlGetData(sqlObjSup);
            if (resultSup.length > 0) {
                Page.setFieldValue("iBscDataManufacturerRecNo", resultSup[0].iRecNo);
            }

            if (Page.usetype == "modify" || Page.usetype == "view") {
                var sqlobj2 = {
                    TableName: "vwSDOrderM_GMJ",
                    Fields: "sName,iBscDataFabRecNo,sBscDataFabCode,sBscDataFabName,fBscDataFabWidth,fBscDataFabWeight,fProductWidth,fProductWeight,fFabQty,sReMark,sUserName,sRollWeight,iBscDataManufacturerRecNo",
                    SelectAll: "True",
                    Filters: [
                    {
                        //字段名
                ...
                if (data2[0].iBscDataManufacturerRecNo) {
                    Page.setFieldValue("iBscDataManufacturerRecNo", data2[0].iBscDataManufacturerRecNo);
                }
            ...
            $("textarea [readonly='readonly']").removeClass("textarea");
        ...
        <div data-options="region:'north'" style="overflow: hidden;">
            ...
            <table class="tabmain">
                ...
                <tr>
                    ...
                    <td>
                        <cc1:ExtTextBox2 ID="ExtTextBox18" runat="server" Z_FieldID="iRcBscDataCustomerRecNo" />
                    </td>
                    <td>落布米数
                    </td>
                    <td>
                        <cc1:ExtTextBox2 ID="ExtTextBox20" runat="server" Z_FieldID="fFabFallQty" Z_FieldType="数值" Z_decimalDigits="2" />
                    </td>
                    <td>匹数
                    </td>
                    <td>
                        <cc1:ExtTextBox2 ID="ExtTextBox16" runat="server" Z_FieldID="iFabQty" Z_FieldType="数值" Z_decimalDigits="0" />
                    </td>
                </tr>
                <tr>
                    <td>坯布编号
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <cc1:ExtTextArea2 ID="ExtTextArea1" runat="server" Width="352px" Z_FieldID="sOrderRemark" class="txareadonly" Z_NoSave="True" Z_readOnly="True" />
                    </td>
                </tr>
                <tr>
                    <td>带刨类型
            ...
            <table class="tabmain">
                <tr>
                    ...
                    <td class="style1">
                        <textarea id="sProReMark" style="border-bottom: 1px solid black; width: 798px; border-left-style: none; border-left-color: inherit; border-left-width: 0px; border-right-style: none; border-right-color: inherit; border-right-width: 0px; border-top-style: none; border-top-color: inherit; border-top-width: 0px;"
                            fieldid="sProReMark"></textarea>
                    </td>
                </tr>
            </table>
        </div>
