...
<body class="easyui-layout">
                        ...
                        <table style="margin: auto;">
                            ...
                            <tr>
                                <td colspan="4" style="text-align: center;">
                                    <a href="#" class="button orange" onclick="StartWarping()">开始织造</a>
                                </td>
                            </tr>
                        </table>
                    </fieldset>
                ...
                <td style="width: 550px;">
                    <fieldset>
                        ...
                        <table style="margin: auto;">
                            ...
                            <tr>
                                <td colspan="4" style="text-align: center;">
                                    <a href="#" class="button orange" onclick="EndWarping()">结束织造</a>
                                </td>
                            </tr>
                        </table>
                    </fieldset>
    ...
    <div data-options="region:'center'">
        <table class="easyui-datagrid" id="table1" data-options="fit:true,border:false,singleSelect:true,collapsible:true,method:'get',rownumbers:true,toolbar:'#dsearch',rowStyler:rowStyle,onClickRow:rowClick">
            <thead>
                <tr>
                    <th data-options="field:'sBillNo',width:120,styler:columnStyle">织造单号</th>
