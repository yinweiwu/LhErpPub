    ...
    try {
        ...
        if (needCLodop()) {
            ...
            if (!LODOP && document.readyState !== "complete") {
                ...
                if (confirm("CLodop云打印服务(localhost本地)未安装启动，是否下载安装？") == true) {
                    window.location.href = "/Base/Lodop/CLodopPrint_Setup_for_Win32NT.exe";
                }
            };
            if (!LODOP) {
                if (isIE) {
                ...
                if (CLODOP.CVERSION < "2.1.0.2") {
                    ...
                    //}
                    if (confirm("CLodop云打印服务需升级，是否下载升级？") == true) {
                        window.location.href = "/Base/Lodop/CLodopPrint_Setup_for_Win32NT.exe";
                    }
                };
            ...
            if ((LODOP == null) || (typeof (LODOP.VERSION) == "undefined")) {
                ...
                if (is64IE) {
                    ...
                    if (confirm("打印控件未安装，是否下载安装？") == true) {
        ...
        if (LODOP.VERSION < "6.2.1.7") {
            if (needCLodop()) {
                ...
                if (confirm("打印控件需要升级，是否下载升级？") == true) {
                    window.location.href = "/Base/Lodop/install_lodop64.exe";
                }
            }
            else if (isIE) {
