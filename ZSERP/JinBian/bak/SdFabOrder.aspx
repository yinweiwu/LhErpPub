            ...
            <table>
                ...
                <tr>
                    <td>
                        五.验收标准：</td>
                    <td>
                        <cc1:ExtTextArea2 ID="ExtTextArea5" Z_FieldID="sCheckStand" runat="server" 
                            Width="403px" Height="70px" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        六.订单可用传真或邮件方式，乙方在本合同项下的欠款，由
                        <cc1:ExtTextBox2 ID="ExtTextBox16" Z_FieldID="sPerson" runat="server" 
                            Width="81px" />
                        个人保证担保，保证期二年。
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        七.结算方式：定金<cc1:ExtTextBox2 ID="ExtTextBox212" 
                            runat="server" Width="35px" Z_FieldID="iSubscription" Z_FieldType="整数" />%&nbsp;&nbsp;
                        <cc1:ExtTextBox2 ID="ExtTextBox23" runat="server" Z_FieldID="sMiddleCostName" 
                            Width="99px" />
                        <cc1:ExtTextBox2 ID="ExtTextBox24" runat="server" Z_FieldID="iMiddleCost" 
                            Width="36px" Z_FieldType="整数" />%&nbsp; 尾款
                        <cc1:ExtTextBox2 ID="ExtTextBox25" runat="server" Z_FieldID="iEndCost" 
                            Width="32px" Z_FieldType="整数" />
                        %</td>
                </tr>
                <tr>
                    <td colspan="2">
                        乙方应于甲方交付产品后<cc1:ExtTextBox2 
                            ID="ExtTextBox17" runat="server" Z_FieldID="iDay" Width="60px" />
                        天内付清该批货款，且双方交易过程中的累积欠款金额不得超过<cc1:ExtTextBox2 ID="ExtTextBox18" runat="server" 
                            Z_FieldID="fMoney" Width="80px" />
                        元
                    </td>
                </tr>
                <tr>
