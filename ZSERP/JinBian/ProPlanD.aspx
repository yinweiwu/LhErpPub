...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(function () {
            Page.setFieldValue("dDate1", addDate(Page.getNowDate(), -7));
            Page.setFieldValue("dDate2", addDate(Page.getNowDate(), 365));
            ...
            $("#ProPlanD").datagrid(
                {
                    ...
                    columns: [[
                        ...
                        { title: "下单日期", field: "sDate", width: 110, sortable: true },
                        { title: "订单号", field: "sOrderNo", width: 110, sortable: true },
                        { title: "染厂", field: "sCustShortName", width: 110, sortable: true },
                        {
                        ...
                        { title: "坯布重量", field: "fPurQty", width: 80, sortable: true },
                        { title: "业务员", field: "sSaleName", width: 80, sortable: true },
            ...
            if (Page.usetype == "add") {
                ...
                Page.setFieldValue('fFabWeight', data2[0].fFabWeight);

                var sqlobj1 = {
                    TableName: "vwProPlanDD_SumWeight",
                    Fields: "fSumWeight",
                    SelectAll: "True",
                    Filters: [
                    {
                ...
                if (data1.length > 0) {
                    Page.setFieldValue('fNotWeight', Number(data2[0].fFabWeight) - Number(data1[0].fSumWeight));
                }
                else {
                    Page.setFieldValue('fNotWeight', Number(data2[0].fFabWeight));
                }
            }
        });
        ...
        function btnPro(row, index) {
            ...
            Page.setFieldValue("fFabWeight", row.fPurQty);
            ...
            var sqlObjProPlanD = {
                ...
                Filters: [
                    ...
                    },
                    {
                        Field: "sDate",
                        ComOprt: ">=",
                        Value: "'" + Page.getFieldValue("dDate1") + "'",
                        LinkOprt: "and"
                    },
                    {
                        Field: "sDate",
                        ComOprt: "<=",
                        Value: "'" + Page.getFieldValue("dDate2") + "'",
                        LinkOprt: "and"
                    },
                    {
                ...
                <div data-options="region:'north'" style="overflow: hidden;">
                    ...
                    <table class="tabmain">
                        ...
                        <tr>
                            ...
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox21" runat="server" Z_FieldID="fFabWeight" Z_NoSave="True"
                        ...
                        <tr>
                            ...
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox17" runat="server" Z_FieldID="fFinishWeight" Z_FieldType="数值"
                                    Z_decimalDigits="2" Z_Required="True" />
                            </td>
                            <td>备注
                            </td>
                            ...
                            <td colspan="7">
                                <table border="1" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <cc1:ExtCheckbox2 ID="ExtCheckbox15" runat="server" Z_FieldID="iProcess15" />
                                        </td>
                                        <td>
                                            <cc1:ExtCheckbox2 ID="ExtCheckbox16" runat="server" Z_FieldID="iProcess16" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
