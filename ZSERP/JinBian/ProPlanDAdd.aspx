        ...
        $(function () {
            if (Page.usetype == "add" || Page.usetype == "modify") {
                $("#dgProPlanD").datagrid(
                {
                    ...
                    columns: [
                    [
                        { field: "sBillNo", title: "加工单号", width: 80, align: "center" },
                        ...
                        { field: "sCustShortName", title: "加工商", width: 80, align: "center" },
                        ...
                        { field: "fOldQty", title: "原下单量", width: 80, align: "center" },
...
<asp:Content ID="Content2" ContentPlaceHolderID="_" runat="Server">
    <div id="divTab" class="easyui-tabs" data-options="fit:true">
        <div title="原外加工单" data-options="fit:true">
            <table id="dgProPlanD">
            </table>
        </div>
                    ...
                    <table class="tabmain">
                        ...
                        <tr>
                            ...
                            <td>
                                工序</td>
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox12" runat="server" Z_FieldID="sBscDataProcessName" 
                                    Z_NoSave="True" Z_readOnly="True" />
                            </td>
                            <td>
                                单位
                            ...
                            <td>
                                <cc1:ExtTextBox2 ID="ExtTextBox13" runat="server" Z_FieldID="sCalcUnitName" Z_readOnly="true"  Z_NoSave="True" />
                            </td>
