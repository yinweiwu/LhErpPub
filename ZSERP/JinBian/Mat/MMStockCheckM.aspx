        ...
        <div data-options="region:'north'" style="overflow: hidden;">
            ...
            <table class="tabmain">
                ...
                <tr>
                    ...
                    <td>
                        <cc1:ExtTextBox2 ID="ExtTextBox13" runat="server" Z_FieldID="fQty" Z_FieldType="数值" Z_decimalDigits="2" Z_disabled="true" />
                    </td>
                    <td style="display: none;">
                        盈亏金额
                    </td>
                    <td style="display: none;">
                        <cc1:ExtTextBox2 ID="ExtTextBox7" runat="server" Z_FieldID="fTotal" Z_FieldType="数值" Z_decimalDigits="2" Z_disabled="true" />
                    </td>
                    <td>
                        制单时间
                    </td>
