...
Page.beforeSave = function () {
    ...
    $(rows).each(function (i, r) {
        ...
        if (r.sOrderNo) {
            ...
            if (("," + sOrders + ",").indexOf("," + r.sOrderNo + ",") >= 0) {
                
            } else {
                if (sOrders) {
                    sOrders = sOrders + "," + r.sOrderNo;
                } else {
                    sOrders = r.sOrderNo;
                }
            }
        ...
        if (r.sStyleNo) {
            if (("," + sStyleNo + ",").indexOf("," + r.sStyleNo + ",") >= 0) {

            } else {
                if (sStyleNo) {
                    sStyleNo = sStyleNo + "," + r.sStyleNo;
                } else {
                    sStyleNo = r.sStyleNo;
                }
            }
    ...
    Page.setFieldValue("sWholeOrderNo",sOrders)
    Page.setFieldValue("sWholeStyleNo",sStyleNo)
...
Page.Children.onEndEdit = function (tableid, index, row, changes) {
    if (tableid == "MMStockOutD") {
        ...
        if (datagridOp.currentColumnName == "fQty") {
            ...
            $("#MMStockOutD").datagrid("updateRow", { index: index, row: { fTotal: fTotal, fPurQty: fPurQty} });
        }
