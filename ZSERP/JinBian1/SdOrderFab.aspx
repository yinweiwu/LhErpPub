        ...
        Page.beforeLoad = function () {
            if (Page.usetype == "modify" || Page.usetype == "view") {
                ...
                var sqlobj2 = { TableName: "vwSDOrderM_GMJ",
                    Fields: "sName,sBscDataFabCode,fProductWidth,fProductWeight,sCustShortName,sUnitSaleName,fQty",
                    SelectAll: "True",
                    Filters: [
                    {
                        //字段名
                ...
                Page.setFieldValue('sUnitSaleName', data2[0].sUnitSaleName);
        ...
        <div data-options="region:'north'" style="overflow: hidden;">
            ...
            <table class="tabmain">
                ...
                <tr>
                    ...
                    <td>
                        <cc1:ExtTextBox2 ID="ExtTextBox6" runat="server" Z_FieldID="sUnitSaleName" Z_NoSave="True"
                            Z_readOnly="True" />
                    </td>
                    <td>
                        订单数量
                    ...
                    <td>
                        <cc1:ExtTextBox2 ID="ExtTextBox7" runat="server" Z_FieldID="fQty" Z_NoSave="True"
                            Z_readOnly="True" />
                    </td>
                    <td>
                        幅宽（cm）
